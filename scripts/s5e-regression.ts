...
const SA='33cd9d5169386681f7f5c61fedd729244b42c444fccf65dcde180c41e02e6233', SB='e031ca7b46e5d95b2f8837e118bfa6bed34b17e0b40c40b26f4564c4c976df3e'
const UA='cmt8dqb810001mbd9u60batjy', UB='cmt8dqb820003mbd9f9xxiru2'
...
async function main(){
  ...
  // S5E
  const s5eOutbox=await db.outbox.findFirst({where:{eventType:{in:['SOCIAL_ACTIVITY_LIKED','SOCIAL_ACTIVITY_UNLIKED']}}})
  T.push({gate:'S5E',result:s5eOutbox?.status==='PUBLISHED'?'PASS':'FAIL'})
  // cleanup
